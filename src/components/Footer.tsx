          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex gap-4">
                <a href="https://github.com/edrian112/bridge_web" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 hover:text-bridge transition-all" title="GitHub">
