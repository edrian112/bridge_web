          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex gap-4">
                <a href="https://github.com/jung-geun/bridge_notes_extension" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 hover:text-bridge transition-all" title="GitHub">
                ...
                <a href="mailto:edari.bridge@gmail.com" className="opacity-80 hover:opacity-100 hover:text-bridge transition-all" title="Email">
